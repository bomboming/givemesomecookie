...
const qnaList = [
    ...
    },
    {
      ...
      a: [
        ...
        { answer: 'B) 칼로리 낮은 아이스크림은 괜찮지 않을까..?(절충안)', type: [15,7,9,31,6,28,0,8] },
    ...
    {
      q: '12.무지개의 색 중 가장 좋아하는 색은',
      a: [
        { answer: 'A)빨강', type: [12,31,0,3] },
        { answer: 'B)주황', type: [7,1,33,20] },
        { answer: 'C)노랑', type: [32,2,19,14] },
        { answer: 'D)초록', type: [25,26,9,28] },
        { answer: 'E)파랑', type: [15,23,16,30] },
        { answer: 'F)남색', type: [22,11,27] },
        { answer: 'G)보라', type: [29,5,32,21] },
      ]
    },
  {
      q: '13.가장 좋아하는 요일은?',
    ...
    },
  {
      ...
      a: [
        ...
        { answer: 'C)석가탄신일', type: [23,3,27] },
        { answer: 'D)어린이날', type: [16,21,29 ] },
        { answer: 'E)3.1절', type: [7,27,2 ]  },
        { answer: 'F)현충일', type: [12,15] },
        { answer: 'G)한글날', type: [4,21,8] },
        { answer: 'H)개천절', type: [25,33,18] },
        { answer: 'I)크리스마스', type: [5,11] },
        { answer: 'J)광복절', type: [32,19,14] },
